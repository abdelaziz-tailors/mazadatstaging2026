...
class UpdateVideoRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'information_ar' => 'nullable|string|max:255',
            'date_start_at' => 'nullable|date_format:Y-m-d',
            'date_end_at' => 'nullable|date_format:Y-m-d',
            'time_start_at' => 'nullable|date_format:H:i',
            'time_end_at' => 'nullable|date_format:H:i',
            'terms_conditions' => 'nullable|string|max:255',
            'terms_conditions_ar' => 'nullable|string|max:255',
            'partner_id' => 'nullable|nullable|required_if:partners_type,single|exists:users,id',
            'video_type' => 'nullable|in:live,recorded,photo',
            'partners_type' => 'nullable',
            'city_id' => 'nullable|nullable|exists:cities,id',
            'type' => 'nullable',
            'tax_amount' => 'nullable|nullable|min:0',
            'commission_amount' => 'nullable|nullable|min:0',
            'commission_payer' => 'nullable|nullable|in:buyer,seller',
            'service_fee' => 'nullable|nullable|min:0',
            'start_price' => 'nullable|numeric|min:0',
            'image' => 'nullable|nullable|array',
            'image.*' => 'nullable|nullable|file|mimes:jpg,jpeg,png,gif,webp|max:5120',
        ];
    }

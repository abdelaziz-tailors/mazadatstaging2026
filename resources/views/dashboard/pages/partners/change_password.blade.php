    ...
    <div class="row">
        <div class="col">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('admin.partners.index')}}">{{ TranslationHelper::translate('partner') }}</a></li>
...
<div class="card">
    <div class="card-body">
	<!--begin::Form-->
	{!! Form::open(['route' => ['admin.partners.save_password', $admin->id], 'files' => false, 'id' => 'kt_form_1', 'data-toggle' => 'validator']) !!}
        <div class="row">

(function ($) {
    ...
    if ($('.owl-carousel.special').length > 0) {
        $('.owl-carousel.special').owlCarousel({
            ...
            responsive: {0: {items: 1}, 500: {items: 2}, 768: {items: 3}, 1000: {items: 4}, 1300: {items: 4}}
        })
    }
    if ($('.owl-carousel.eye-clinic').length > 0) {
        $('.owl-carousel.eye-clinic').owlCarousel({
            ...
            smartSpeed: 2000,
            navText: ['<i class="fas fa-chevron-left"></i>', '<i class="fas fa-chevron-right"></i>'],
            responsive: {0: {items: 1}, 500: {items: 1}, 768: {items: 2}, 992: {items: 3}, 1200: {items: 4}}
        })
    }
    if ($('.owl-carousel.eye-blogslider').length > 0) {
        $('.owl-carousel.eye-blogslider').owlCarousel({
            ...
            smartSpeed: 2000,
            navText: ['<i class="fas fa-chevron-left"></i>', '<i class="fas fa-chevron-right"></i>'],
            responsive: {0: {items: 1}, 500: {items: 1}, 768: {items: 3}, 1000: {items: 4}, 1300: {items: 4}}
        })
    }
    if ($('.owl-carousel.eye-blogslider').length > 0) {
        $('.owl-carousel.eye-blogslider').owlCarousel({
    ...
    if ($('.owl-carousel.eye-testislider').length > 0) {
        $('.owl-carousel.eye-testislider').owlCarousel({
            ...
            responsive: {0: {items: 1}, 1300: {items: 1}}
        })
    }
    if ($('.owl-carousel.specialities-slider-one').length > 0) {
        $('.owl-carousel.specialities-slider-one').owlCarousel({
            ...
            responsive: {0: {items: 1}, 500: {items: 1}, 768: {items: 2}, 1000: {items: 3}, 1300: {items: 6}}
        })
    }
    if ($('.owl-carousel.specialities-slider-two').length > 0) {
        $('.owl-carousel.specialities-slider-two').owlCarousel({
            loop: true,
            margin: 24,
            dots: false,
            nav: true,
            smartSpeed: 2000,
            navContainer: '.slide-nav-100',
            navText: ['<i class="fas fa-chevron-left custom-arrow"></i>', '<i class="fas fa-chevron-right custom-arrow"></i>'],
            responsive: {0: {items: 1}, 500: {items: 1}, 768: {items: 2}, 1000: {items: 3}, 1300: {items: 6}}
        })
    }
    if ($('.owl-carousel.specialities-slider-three').length > 0) {
        $('.owl-carousel.specialities-slider-three').owlCarousel({
            loop: true,
            margin: 24,
            dots: false,
            nav: true,
            smartSpeed: 2000,
            navContainer: '.slide-nav-101',
            navText: ['<i class="fas fa-chevron-left custom-arrow"></i>', '<i class="fas fa-chevron-right custom-arrow"></i>'],
            responsive: {0: {items: 1}, 500: {items: 1}, 768: {items: 2}, 1000: {items: 3}, 1300: {items: 6}}
        })
    }
    if ($('.owl-carousel.doctor-slider-one').length > 0) {
        $('.owl-carousel.doctor-slider-one').owlCarousel({
            ...
            navText: ['<i class="fas fa-chevron-left custom-arrow"></i>', '<i class="fas fa-chevron-right custom-arrow"></i>'],
            responsive: {0: {items: 1}, 500: {items: 1}, 768: {items: 2}, 1000: {items: 3}, 1300: {items: 4}}
        })
    }
    if ($('.owl-carousel.team-fourteen-slider').length > 0) {
        $('.owl-carousel.team-fourteen-slider').owlCarousel({
            ...
            responsive: {0: {items: 1}, 500: {items: 1}, 768: {items: 2}, 1000: {items: 2}, 1300: {items: 2}}
        })
    }
    if ($('.owl-carousel.features-slider-sixteen').length > 0) {
        $('.owl-carousel.features-slider-sixteen').owlCarousel({
            ...
            nav: false,
            smartSpeed: 2000,
            responsive: {0: {items: 1}, 500: {items: 1}, 768: {items: 2}, 1000: {items: 3}, 1300: {items: 3}}
        })
    }
    ...
    if ($('.owl-carousel.feedback-slider-fourteen').length > 0) {
        $('.owl-carousel.feedback-slider-fourteen').owlCarousel({
            ...
            smartSpeed: 2000,
            navText: ['<i class="fa-solid fa-caret-left "></i>', '<i class="fa-solid fa-caret-right"></i>'],
            responsive: {0: {items: 1}, 500: {items: 1}, 768: {items: 1}, 1000: {items: 1}, 1300: {items: 1}}
        })
    }
    ...
    if ($('.owl-carousel.partners-slider').length > 0) {
        $('.owl-carousel.partners-slider').owlCarousel({
            ...
            autoplay: true,
            smartSpeed: 2000,
            responsive: {0: {items: 1}, 550: {items: 2}, 700: {items: 4}, 1000: {items: 6}}
        })
    }
    if ($('.owl-carousel.doctor-slider-one').length > 0) {
        $('.owl-carousel.doctor-slider-one').owlCarousel({
    ...
    if ($(' #slide-experts').length > 0) {
        $('#slide-experts').owlCarousel({
            ...
            nav: false,
            dots: false,
            responsive: {0: {items: 1}, 768: {items: 1, margin: 15,}, 1000: {items: 3,}}
        });
    }
    ;
    if ($('.owl-carousel.feedback-slider-fourteen').length > 0) {
    ...
    if ($('.doctor-slider').length > 0) {
        $('.doctor-slider').slick({dots: false, autoplay: false, infinite: true, variableWidth: true,});
    }
    ...
    if ($('.clinic-slider').length > 0) {
        $('.clinic-slider').slick({
            ...
            }, {breakpoint: 776, settings: {slidesToShow: 3}}, {breakpoint: 567, settings: {slidesToShow: 1}}]
        });
    }
    ...
    if ($('.book-slider').length > 0) {
        $('.book-slider').slick({
            ...
            responsive: [{breakpoint: 992, settings: {slidesToShow: 3}}, {
                breakpoint: 800,
                settings: {slidesToShow: 3}
            }, {breakpoint: 776, settings: {slidesToShow: 2}}, {breakpoint: 567, settings: {slidesToShow: 1}}]
        });
    }
    ...
    if ($('.pharmacy-home-slider .swiper-container').length > 0) {
        var swiper = new Swiper('.pharmacy-home-slider .swiper-container', {
            loop: true,
            speed: 1000,
            pagination: {el: '.pharmacy-home-slider .swiper-pagination', dynamicBullets: true, clickable: true,},
            navigation: {
    ...
    if ($('.owl-carousel.clinics').length > 0) {
        $('.owl-carousel.clinics').owlCarousel({
            ...
            navContainer: '.slide-nav-1',
            navText: ['<i class="fas fa-chevron-left custom-arrow"></i>', '<i class="fas fa-chevron-right custom-arrow"></i>'],
            responsive: {0: {items: 1}, 500: {items: 1}, 768: {items: 3}, 1000: {items: 4}, 1300: {items: 6}}
        })
    }
    if ($('.owl-carousel.our-doctors').length > 0) {
        $('.owl-carousel.our-doctors').owlCarousel({
            ...
            navContainer: '.slide-nav-2',
            navText: ['<i class="fas fa-chevron-left custom-arrow"></i>', '<i class="fas fa-chevron-right custom-arrow"></i>'],
            responsive: {0: {items: 1}, 500: {items: 1}, 768: {items: 2}, 1000: {items: 3}, 1200: {items: 4}}
        })
    }
    if ($('.owl-carousel.clinic-feature').length > 0) {
        $('.owl-carousel.clinic-feature').owlCarousel({
            ...
            navText: ['<i class="fas fa-chevron-left custom-arrow"></i>', '<i class="fas fa-chevron-right custom-arrow"></i>'],
            responsive: {0: {items: 1}, 500: {items: 1}, 768: {items: 3}, 1000: {items: 4}, 1300: {items: 5}}
        })
    }
    ...
    if ($('#bmi-status').length > 0) {
        var options = {
            series: [{name: "BMI", data: [10, 41, 35, 51, 49, 62, 69, 91, 148]}],
    ...
    if ($('#heartrate-status').length > 0) {
        var options = {
            ...
            markers: {size: 4, colors: ["#15558d"], strokeColors: "#fff", strokeWidth: 2, hover: {size: 7,}},
            yaxis: {min: -10, max: 40, title: {},}
        };
    ...
    if ($('#fbc-status').length > 0) {
        var options = {
            series: [{name: 'FBC', data: [2.3, 3.1, 4.0, 10.1, 4.0, 3.6, 3.2, 2.3, 1.4, 0.8, 0.5, 0.2]}],
            ...
            title: {floating: true, offsetY: 330, align: 'center', style: {color: '#444'}}
        };
    ...
    if ($('#weight-status').length > 0) {
        var options = {
            series: [{name: 'Weight', data: [34, 44, 54, 21, 12, 43, 33, 23, 66, 66, 58]}],
    ...
    if ($('#price-range').length > 0) {
        ...
        $("#price-range").slider({
            range: true, min: 10, max: 10000, values: [10, 5000], slide: function (event, ui) {

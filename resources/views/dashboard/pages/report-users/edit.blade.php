...
{!! Form::model($gift, ['route' => ['admin.report-users.update', $gift->id], 'method' => 'PUT', 'files' => true, 'id' => 'kt_form_1', 'data-toggle' => 'validator']) !!}
    @include('dashboard.pages.report-users._form')
{!! Form::close() !!}
@endsection

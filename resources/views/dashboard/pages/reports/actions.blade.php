<div class="btn-group">
    ...
    <div class="dropdown-menu">
        @if (Auth::guard('admin')->user()->can('edit report'))
            <a class="dropdown-item" href="{{ route('admin.reports.edit', $item->id) }}">
                <i class="fas fa-edit"></i> {{ TranslationHelper::translate('edit') }}
            </a>
        @endif

    @if (Auth::guard('admin')->user()->can('delete report'))
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form role="form" action="{{ url('/admin/reports/'.$item->id) }}" class="" method="POST">

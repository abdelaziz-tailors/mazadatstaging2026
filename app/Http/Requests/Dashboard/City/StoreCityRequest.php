...
class StoreCityRequest extends FormRequest
{
    ...
    public function messages()
    {
        ...
        $messages['country_id.required'] = TranslationHelper::translate('Please Choose country');
        $messages['country_id.exists'] = TranslationHelper::translate('Selected country Not Exist');
        return $messages;
    }
}

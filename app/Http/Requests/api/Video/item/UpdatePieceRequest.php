...
class UpdatePieceRequest extends FormRequest
{
    ...
    /**
     * Get the validation rules that apply to the request — every field is
     * optional since this is a partial update (only fields actually

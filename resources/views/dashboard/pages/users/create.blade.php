...
@section('title') {{ TranslationHelper::translate('add_new_buyer') }} @endsection
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-start justify-content-between gap-3 mb-3">
                    <div>
                        <h3 class="page-title mb-1">{{ TranslationHelper::translate('add_new_buyer') }}</h3>
                        <ul class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard.index') }}">{{ TranslationHelper::translate('dashboard') }}</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('admin.users.index', ['user_type' => 'buyer']) }}">{{ TranslationHelper::translate('Buyers') }}</a></li>
                            <li class="breadcrumb-item active">{{ TranslationHelper::translate('add_new_buyer') }}</li>
                        </ul>
                    </div>
                ...
                {!! Form::open(['route' => 'admin.users.store', 'id' => 'kt_form_1', 'data-toggle' => 'validator']) !!}

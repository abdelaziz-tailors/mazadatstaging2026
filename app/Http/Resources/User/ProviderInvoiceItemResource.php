...
use App\Http\Resources\User\VideoItemPieceResource as UserVideoItemPieceResource;
use App\Http\Resources\VideoItemPieceResource;
...
class ProviderInvoiceItemResource extends JsonResource
{
    public function toArray($request)
    {
        ...
        return [
            ...
            'pieces' => UserVideoItemPieceResource::collection($this->pieces),
        ];
    }
}
